...
* For Resource Type: `Job Template`, select all the job templates that begin with `Linux/RHEL`, and click `Next`. Please select `Job Template Execute` as the role to apply -> Review your work and click `Finish`
