...
image::createteam.png[Screenshot of Ansible Automation Platform Create Team dialog with Name field, Organization dropdown, and blue Create Team button]
...
image::assignroles.png[Screenshot showing Roles tab with Assign roles button to configure team permissions in Ansible Automation Platform]
...
image::selectjobtemplates.png[Screenshot of resource selection interface showing multiple Cloud/AWS job templates available for team assignment]
image::finish1strole.png[Screenshot of role assignment review screen with Finish button to complete job template permissions configuration]
...
image::assigninventoryrole.png[Screenshot showing inventory selection with AWS, Azure, and GCP inventories being assigned Use permission for cloud-team]
...
image::assigncredentialrole.png[Screenshot displaying credential selection with AWS, Azure, and RHEL SSH credentials being assigned Use permission]
...
image::assignuserrole.png[Screenshot of Users tab showing Assign users interface with clouduser1 being added to cloud-team]
...
image::ssapadmin.png[Screenshot of Self-Service Portal home page showing administrator view with all available job templates from Cloud, Network, and RHEL categories]
...
image::ssaprbac.png[Screenshot showing Administration menu with RBAC option for creating permission policies in Self-Service Portal]
...
image::ssa-portal-users-role.png[Screenshot of RBAC role creation showing ssa-portal-users policy with cloud-team and network-team assigned catalog and scaffolder permissions]
...
image::rolecondition.png[Screenshot showing conditional RBAC configuration with Not HAS_METADATA rule where key is tags and value is custom]
image::saa-portal-rhel-team-role.png[Screenshot of saa-portal-rhel-team policy configuration with rhel-team assigned permissions and conditional rule excluding custom tagged templates]

The final view of this section should look like this:

image::final-rbac-roles.png[Screenshot showing completed RBAC configuration with both ssa-portal-users and saa-portal-rhel-team policies listed in Administration RBAC view]
