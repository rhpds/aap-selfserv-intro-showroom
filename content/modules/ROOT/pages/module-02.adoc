...
image::clouduser1.png[Self-Service Portal clouduser1 user can see the Cloud job templates,link=self,window=blank]

=== Test cloud automation execution

Let's run a cloud job template to validate permissions:

**1. Select a job template to run:**
...
[NOTE]
====
**Key learning**: Notice how you can execute powerful cloud automation without knowing Ansible syntax or accessing the full AAP interface. This is the self-service experience that broadens automation adoption.
====
...
image::networkuser1.png[Self-Service Portal networkuser1 user can see the Network job templates,link=self,window=blank]
...
image::rheluser1.png[Self-Service Portal rheluser1 user can see the RHEL job templates,link=self,window=blank]
