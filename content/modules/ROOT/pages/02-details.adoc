...
You will receive the following access details for your environment:

* **Ansible Automation Platform URL**: `{aap_controller_url}`
* **Self-Service Portal URL**: `{self_service_portal_url}`
