...
image::survey1.png[Screenshot of Ansible Automation Platform job template interface showing Surveys tab with Create survey question button]
...
image::survey2.png[Screenshot showing survey question creation dialog with Question field, Answer variable name field set to enable_service, and Answer type dropdown set to Multiple Choice single select]
...
image::jtsync.png[Screenshot of Self-Service Portal showing Sync now button with dialog prompting to select synchronization options including Job Templates checkbox]
...
image::survey3.png[Screenshot of Self-Service Portal as rheluser1 launching Linux/RHEL START Service job template showing new survey question about enabling service after reboot]
...
image::custom1.png[Screenshot showing Add Template interface in Self-Service Portal with Select URL option and GitHub repository URL input field for importing custom dynamic template]
...
image::custom2.png[Screenshot of custom template review screen showing YAML template details with metadata, parameters, and steps before import confirmation]

** When you see `Step 4 Finish` the custom dynamic template will be imported successfully.

image::custom3.png[Screenshot showing Step 4 Finish with success message confirming custom dynamic template has been imported successfully into Self-Service Portal]
...
image::custom4.png[Screenshot of Self-Service Portal logged in as rheluser1 showing newly imported Manage RHEL Time Servers custom template alongside standard RHEL job templates]
...
image::custom5.png[Screenshot showing custom dynamic template launch interface with multiple configuration options including Show Advanced Options checkbox and parameter input fields for RHEL time server configuration]
